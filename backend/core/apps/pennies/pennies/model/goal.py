from typing import List, ClassVar, Literal, Union
from uuid import UUID, uuid4

from pydantic import BaseModel, Field

from pennies.model.investment import Investment, Cash, ALL_NON_GUARANTEED_INVESTMENTS, AllNonGuaranteedInvestments
