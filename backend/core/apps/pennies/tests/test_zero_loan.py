...
from pennies.model.interest_rate import FixedLoanInterestRate, ZeroGrowthRate
from pennies.model.investment import MutualFund
from pennies.model.loan import LineOfCredit, PersonalLoan, StudentLineOfCredit, StudentLoan
from pennies.model.request import PenniesRequest, RequestInvestment, RequestInvestmentType
...
def make_request():
    return PenniesRequest(
        ...
        goals=list(),
        strategies=[strategies.StrategyName.lp.value, strategies.StrategyName.snowball.value]
    )
